...
I didn't build this alone. As a novice, I collaborated extensively with AI assistants, `Claude` and `DeepSeek`, to guide the process. They acted as my technical mentors, helping me:
  ...
  * Structure the project from scratch.

  * Debug JavaScript logic for accurate financial formulas.

  * Understand Git and GitHub, which was a major initial hurdle.
<!--more-->
...
The calculator allows you to input an asset's cost, salvage value, and useful life. With a click, it generates a year-by-year depreciation schedule using the Straight-Line method (with more methods coming soon!). It presents the data in a clear table and will soon feature charts for visualization. It’s clean, responsive, and, most importantly, accurate to accounting standards.
<!--more-->
## What's Next?

This is just Phase 1. I'm currently working on Phase 2, which will add the Declining Balance and Sum-of-the-Years-Digits methods. Future plans include interactive charts and export functionality.
<!--more-->
## Key Takeaway
